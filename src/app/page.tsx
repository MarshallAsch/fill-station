		...
		<div className='text-center'>
			...
			<div className='mx-auto mt-5 max-w-md sm:flex sm:justify-center md:mt-8'>
				<div className='-mx-6 grid grid-cols-2 gap-0.5 overflow-hidden sm:mx-0 sm:rounded-2xl md:grid-cols-3'>
					<Link
						href='fills'
						className='flex cursor-pointer flex-col items-center justify-between gap-2 bg-gray-400/5 p-6 transition hover:bg-gray-400/10 dark:bg-gray-600/10 dark:hover:bg-gray-600/20 sm:p-10'
					>
						<AirTank />
						<p>Fills</p>
					</Link>
			...
			<div className='my-10 text-center'>
				<h2 className='text-4xl font-semibold tracking-tight text-balance text-gray-900 dark:text-gray-100 sm:text-5xl'>
					Services Offered
				</h2>
			</div>
			<Services />
