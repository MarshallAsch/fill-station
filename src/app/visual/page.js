  ...
  return (
    <div className="flex flex-col overflow-auto">
      ...
      <FormControl>
        ...
        <RadioGroup aria-labelledby="bulge" defaultValue="no" name="bulge" row>
          <FormControlLabel value="no" control={<Radio />} label="No" />
          <FormControlLabel value="yes" control={<Radio />} label="Yes" />
        </RadioGroup>
      </FormControl>
      ...
      <FormControl>
        <FormLabel id="tone-test">Hammer tone test - bell like sound</FormLabel>
        <RadioGroup
      ...
      <FormControl>
        ...
        <RadioGroup aria-labelledby="oring" defaultValue="yes" name="oring" row>
          <FormControlLabel value="yes" control={<Radio />} label="Yes" />
          <FormControlLabel value="no" control={<Radio />} label="No" />
        </RadioGroup>
      </FormControl>
