...
// lines never overlap and magnitudes stay readable. All panels share the x-axis
// (passed via xCaption — time, or receiver pressure in the fallback); the SVG
// scales uniformly to the container width.
const W = 320
const H = 60
const PAD = 6
