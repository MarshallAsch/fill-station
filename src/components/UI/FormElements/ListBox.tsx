	...
	return (
		<Listbox value={selected} onChange={setSelected}>
			...
			<div className=''>
				...
				<ListboxOptions
					transition
					className='absolute z-60 mt-1 max-h-60 w-full max-w-100 overflow-auto rounded-md bg-white py-1 text-base shadow-lg outline-1 outline-black/5 data-leave:transition data-leave:duration-100 data-leave:ease-in data-closed:data-leave:opacity-0 dark:bg-gray-800 dark:outline-gray-700 sm:text-sm'
				>
