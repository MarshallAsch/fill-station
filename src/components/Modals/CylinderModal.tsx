...
const CylinderModal = ({
	...
	return (
		<Transition show={true} as={Fragment}>
			<Dialog as='div' onClose={handleClose} className='relative z-9999'>
				<TransitionChild
					as={Fragment}
				...
				<div className='fixed inset-0 z-40 overflow-y-auto'>
					<div className='relative flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0'>
						...
						>
							<DialogPanel className='transform overflow-hidden rounded-lg bg-white dark:bg-gray-800 px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6'>
